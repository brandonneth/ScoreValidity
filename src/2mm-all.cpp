...
dec.set_format_for(b,blayouts[b0],knl1);
dec.set_format_for(b,blayouts[b1],knl2);
dec.set_output_format(b,blayouts[b2]);
dec.set_format_for(c,clayouts[c0],knl1);
dec.set_format_for(c,clayouts[c1],knl2);
dec.set_output_format(c,clayouts[c2]);
