...
int main() {
  ...
  std::cerr << "View Side Length = 242...\n";
  footprint_experiment<242>();
  std::cerr << "View Side Length = 342...\n";
  footprint_experiment<342>();
  std::cerr << "View Side Length = 484...\n";
  footprint_experiment<484>();
  std::cerr << "View Side Length = 1186...\n";
  footprint_experiment<1186>();
  std::cerr << "View Side Length = 1678...\n";
  footprint_experiment<1678>();
  std::cerr << "View Side Length = 2373...\n";
  footprint_experiment<2373>();
  std::cerr << "View Side Length = 3162...\n";
  footprint_experiment<3162>();
  std::cerr << "View Side Length = 4472...\n";
  footprint_experiment<4472>();
  std::cerr << "View Side Length = 6324...\n";
  footprint_experiment<6324>();
